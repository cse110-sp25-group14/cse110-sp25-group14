...
* We needed to consider the time we as a team and we individually would have to work on this project. We wanted to choose something doable within our given time constraints. 
* We considered topics that seemed interesting to us so that it would not be a bore to create. 
...
* Gambling/Blackjack
* Credit card manager
* Human benchmark application/memory game
...
* Good, because it is not too complicated backend-wise.
* * Good, because we all are very interested and enthusiastic to work with this topic.
...
* Good, because simple and useful, much like Quizlet.
* Bad, because it might be too basic, and Quizlet already exists. 

### Gambling/blackjack


* Good, because we have previous experience with working with and coding with playing cards.
* Bad, because it is not a good opportunity for our learning since it is not too far off from the warm-up activity. 

### Credit card manager


* Good, because it seems interesting and useful.
* Bad, because we have to worry about security, and we are inexperienced with that. 
