...
| --- | --- | --- | --- | --- |
| accepted | 2025-05-22 when the decision was first proposed, 2025-06-07 when the decision was last updated | Victoria, Emily, Carl | Aarush, Gautam, Mark, Eric, Travis, Nilay, Srideep, Kilhoon | Aarush, Gautam, Mark, Eric, Travis, Nilay, Srideep, Kilhoon |


# Default Theme for Matching Game and Alternative Group Culture Theme 
...
* Shapes
* Basketball theme 
* Professor Powell Theme
* Group culture icons theme
...
Basketball icons since many of our group members love basketball. 

* Good, because the icons can look simple on the game cards by either using images of basketballs or basketball team logos.
* Bad, because not all our target users enjoy basketball.

### Professor Powell Theme

Professor Powell icons

* Good, because it is humorous and silly.
* Bad, because it is not professional and not all our target users would use this theme since both extremes of age groups (and any age group in between) may not be familiar with our professor. The other chosen themes are a perfect mix of fun and professional. 
